                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) => Detail(
                                      category: widget.data[productIndex1]
                                          ['ingrId'])));
                        },
                        child: Image.asset(
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => IngrMain(
                                      catId: widget.data[productIndex1]
                                          ['category']['catId'],
                                      subCatId: 0,
                                      catName: widget.data[productIndex1]
                                          ['category']['catName'],
                                      sortNum: 0)));
                        },
                        child: Text(
                          ...
                          children: [
                            Container(
                              ...
                              child: InkWell(
                                onTap: () {
                                  clickIngr(
                                      widget.data[productIndex1]['ingrId']);
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => Detail(
                                              category:
                                                  widget.data[productIndex1]
                                                      ['ingrId'])));
                                },
                                child: Image.asset(
                                  'assets/images/ingr/${widget.data[productIndex1]['ingrName']}.jpg',
                            ...
                            InkWell(
                              ...
                              child: SizedBox(
                                ...
                                child: Text(
                                  '${widget.data[productIndex1]['ingrName'].toString().length > 7 ? widget.data[productIndex1]['ingrName'].toString().substring(0, 7) : widget.data[productIndex1]['ingrName']}'
                                  '${widget.data[productIndex1]['title'].toString().length > 7 ? "..." : ""}',
                                  style: TextStyle(
                                    fontSize: 19,
                                    fontWeight: FontWeight.w600,
                                  ),
                          ...
                          children: [
                            Container(
                              ...
                              child: InkWell(
                                onTap: () {
                                  clickIngr(
                                      widget.data[productIndex2]['ingrId']);
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => Detail(
                                              category:
                                                  widget.data[productIndex2]
                                                      ['ingrId'])));
                                },
                                child: Image.asset(
                              ...
                              child: InkWell(
                                onTap: () {
                                  Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (context) => IngrMain(
                                              catId: widget.data[productIndex2]
                                                  ['category']['catId'],
                                              subCatId: 0,
                                              catName:
                                                  widget.data[productIndex2]
                            ...
                            InkWell(
                              onTap: () {
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) => Detail(
                                            category: widget.data[productIndex2]
                                                ['ingrId'])));
                              },
                              child: SizedBox(
                                height: 35,
                                child: Text(
                                  '${widget.data[productIndex2]['ingrName'].toString().length > 7 ? widget.data[productIndex2]['ingrName'].toString().substring(0, 7) : widget.data[productIndex2]['ingrName']}'
                                  '${widget.data[productIndex2]['ingrName'].toString().length > 7 ? "..." : ""}',
                                  style: TextStyle(
                                    fontSize: 19,
                                    fontWeight: FontWeight.w600,
                                  ),
